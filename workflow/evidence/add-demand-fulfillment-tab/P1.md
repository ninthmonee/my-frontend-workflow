...
## Key Decisions
- 单文件 5 处：demand* 状态+数据源、tab item（产能分配结果后）、subAppHeight 双分支、params 9 参数分支、独立模板块（7 筛选项 + name=demand-fulfillment）
- 复用已有数据源（customerRegionSumFilterOptions/regionOptions/materialOptions 等），未新增 API
